...
Deployment of the template project in **AWS**, managed end to end with **Terraform** and **Kubernetes manifests**. No domain in dev: the app is served plain-HTTP on the ALB's DNS name. No domain because of cost and this is just a template.
